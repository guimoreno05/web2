...
!function($) {
    ...
    $.support.touch = (function () {
      return ('ontouchend' in document || 'onmspointerup' in document)
    })()
    ...
    var Touch = function (element,options) {
        ...
        $.support.touch && this.$element
			...
			.on('MSPointerDown', $.proxy(this.start, this))
            .on('MSPointerMove', $.proxy(this.move, this))
            .on('MSPointerUp', $.proxy(this.end, this))
    }
    ...
    Touch.prototype = {
      ...
      , start: function(e) {
			...
			if (e.originalEvent)
			{
				var touches = e.originalEvent.touches ? e.originalEvent.touches[0] : e.originalEvent;
			}
			else
			{
				var touches = e;
      ...
      , end: function(e) {
            ...
            var distance = (this.touch.startX === 0 || this.touch.endX === 0) ? 0 : Math.abs(this.touch.endX - this.touch.startX)
